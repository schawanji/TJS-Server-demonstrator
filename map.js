...
form.addEventListener("submit", (event) => {
  ...
  const url = `http://localhost:5001/tjs/api/joindata?FrameworkURI=http://localhost:8081/geoserver/osm/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=osm%3Aus-states&maxFeatures=50&outputFormat=application%2Fjson&layer=osm:us-states&GetDataURL=http://localhost:5001/static/covid_data.csv&FrameworkKey=name&AttributeKey=state`;  
